...
function entry(t){
  ...
  document.getElementById("entrySearchBtn").onclick=()=>filterTable("entryTable",document.getElementById("entrySearch").value);
...
function stock(t){
  ...
  document.getElementById('stockSearchBtn').onclick=()=>filterTable('stockTable',document.getElementById('stockSearch').value);
...
function renderStatement(title,h,rows){
  ...
  document.getElementById("statementSearchBtn").onclick=()=>filterTable("statementTable",document.getElementById("statementSearch").value);
...
function filterTable(tableId,query){
  ...
  table.querySelectorAll('tbody tr').forEach(tr=>{
    ...
    const isMatch=cells.some((cell,i)=>tableId==="entryTable"&&i===cells.length-1?false:exactSearchMatch(cell.textContent,q));
